    ...
    def _parse_nodes(self, raw_nodes: list) -> list[dict]:
        ...
        for node in raw_nodes:
            ...
            _LOGGER.info(
                ...
                node_id, name, name_source, product_name, has_time_sync
            )
